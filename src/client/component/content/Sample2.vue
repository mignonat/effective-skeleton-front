        ...
        <div id="visualize-loan" class="visualize-loan">
            <div id="informations-vizualize-loan">
                <div id="project-amount">
                    <span class="value-visualize-loan" v-html:value="amount"></span>
                    <span class="unit-visualize-loan" v-html:value="unit"></span>
                    <span class="label-visualize-loan"> Project Amount </span>
                </div>
                <div id="real-estate-investment">
                    <span class="value-visualize-loan" v-html:value="investment"></span>
                    <span class="unit-visualize-loan"  v-html:value="unit">;</span>
                    <span class="label-visualize-loan">Real estate investment </span>
                </div>
                <div id="notary-fees">
                    <span class="value-visualize-loan" v-html:value="notaryFees"></span>
                    <span class="unit-visualize-loan"  v-html:value="unit"></span>
                    <span class="label-visualize-loan">Notary fees </span>
                </div>
                <div id="others-fees">
                    <span class="value-visualize-loan" v-html:value="othersFees"></span>
                    <span class="unit-visualize-loan"  v-html:value="unit"></span>
                    <span class="label-visualize-loan">Others fees </span>
                </div>
                <div id="times-loan">
                    <span class="value-visualize-loan" v-html:value="duration"></span>
                    <span class="unit-visualize-loan" v-html:value="scale"></span>
